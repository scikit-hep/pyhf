...
.. note::
   ...
   ATLAS maintains a public list of all published statistical models on the
   `supersymmetry searches public results webpage
   <https://twiki.cern.ch/twiki/bin/view/AtlasPublic/SupersymmetryPublicResults>`__.
