...
.. raw:: html
   ...
   <p id="old-version"><strong>Warning:</strong> This is not a stable version. The latest stable version is <a id="latest-version-link" href="https://pyhf.readthedocs.io/">v?.?.?</a>.</p>
