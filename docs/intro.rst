...
.. table:: Modifiers and Constraints
    ...
    Normalisation Unc.   :math:`\kappa_{sc}(\alpha) = g_p\left(\alpha\middle|\,\kappa_{sc,\alpha=-1},\kappa_{sc,\alpha=1}\right)`   :math:`\displaystyle\mathrm{Gaus}\left(a = 0\middle|\,\alpha,\sigma = 1\right)`                       :math:`\kappa_{sc,\alpha=\pm1}`
